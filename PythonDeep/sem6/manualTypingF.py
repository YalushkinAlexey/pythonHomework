# @@@ Данная программа помогает расставлять 8 ферзей в ручную на доску 64 клеток
# Попутно проверяя на возможность установки комбинации. Комбинации задаются в строку переменная coordinates
# Для примера забиты 2 варианта, 1ый не устраивающий по условию, и 2й годный к применению
# Добавлена функция генерации координат ферзей, через псевдо генератор случ. чисел

# Вместе ручной и рандомный не работают. Тех поддержка в курсе ;)
...
#Тут мы смотрим можно ли воткнуть ферзя или нет
